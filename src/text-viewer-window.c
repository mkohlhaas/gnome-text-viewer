...
static void text_viewer_window__update_cursor_position (GtkTextBuffer *buffer, GParamSpec *pspec,
                                                        TextViewerWindow *self);

static void
text_viewer_window__update_cursor_position (GtkTextBuffer *buffer, GParamSpec *pspec G_GNUC_UNUSED,
                                            TextViewerWindow *self)
{
  ...
  int              offset     = gtk_text_iter_get_line_offset (&iter) + 1;
  g_autofree char *cursor_str = g_strdup_printf ("Ln %d, Col %d", line, offset);

  gtk_label_set_text (self->cursor_pos, cursor_str);
}

static void
open_file_complete (GObject *source_object, GAsyncResult *result, TextViewerWindow *self)
{
  ...
  // Complete the asynchronous operation; this function will either give you the contents of the file as a byte array,
  // or will set the error argument.
...
static void
text_viewer_window__open_file_dialog (GAction *action G_GNUC_UNUSED, GVariant *parameter G_GNUC_UNUSED,
                                      TextViewerWindow *self)
{
...
static void
text_viewer_window__save_file_dialog (GAction *action G_GNUC_UNUSED, GVariant *param G_GNUC_UNUSED,
                                      TextViewerWindow *self)
{
  g_autoptr (GtkFileDialog) dialog = gtk_file_dialog_new ();
